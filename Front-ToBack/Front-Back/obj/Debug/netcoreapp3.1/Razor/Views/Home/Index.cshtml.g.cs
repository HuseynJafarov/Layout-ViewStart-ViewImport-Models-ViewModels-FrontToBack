#pragma checksum "C:\Users\HP\Desktop\CodeAcademy\ASP.NET Core\FrontToBack\Front-Back\Front-Back\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9919edf39bfbab9b72447d87f5ce159a035130eb"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9919edf39bfbab9b72447d87f5ce159a035130eb", @"/Views/Home/Index.cshtml")]
    ...
    #nullable disable
    {
        ...
        {
#nullable restore
#line 1 "C:\Users\HP\Desktop\CodeAcademy\ASP.NET Core\FrontToBack\Front-Back\Front-Back\Views\Home\Index.cshtml"
    ...
    <div class=""row gx-5 gx-sm-3 gx-lg-5 gy-lg-5 gy-3 pb-3");
        ...
        <div class=""col-xl-3 col-md-4 col-sm-6 project ui branding"">
            <a href=""#"" class=""service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0"">
                <img class=""service card-img"" scr=""~/assets/img/services-01.jpg"" alt=""Card image"">
        ...
        <div class=""col-xl-3 col-md-4 col-sm-6 project ui graphic"">
            <a href=""#"" class=""service-work card border-0 text-white shadow-sm overflo");
            WriteLiteral(@"w-hidden mx-5 m-sm-0"">
                <img class=""card-img"" scr=""~/assets/img/services-02.jpg"" alt=""Card image"">
                <div class=""service-work-vertical card-img-overlay d-flex align-items-end"">
                    <div class=""service-work-content text-left text-light"">
        ...
        <div class=""col-xl-3 col-md-4 col-sm-6 project branding"">
            <a href=""#"" class=""service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0"">
                <img class=""card-img"" scr=""~/assets/img/services-03.jpg"" alt=""Card image"">
                <div class=""service-work-vertical card-img-overlay d-flex align-items-end"">
        ");
        ...
        <div class=""col-xl-3 col-md-4 col-sm-6 project ui graphic"">
            <a href=""#"" class=""service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0"">
                <img class=""card-img"" scr=""~/assets/img/services-04.jpg"" alt=""Card image"">
                <div class=""service-work-vertical card-img-overlay d-flex align-items-end"">
                    <div class=""service-work-content text-left text-light"">
                        <span class=""btn btn-outline-light rounded-pill mb-lg-3 px-lg-4 light-300"">Graphic</span>
                        <p class=""");
            WriteLiteral(@"card-text"">Lorem ipsum dolor sit amet, consectetur adipisicing</p>
                    </div>
                </div>
            </a>
        </div><!-- End Recent Work -->
        ...
        <div class=""col-xl-3 col-md-4 col-sm-6 project ui graphic"">
            <a href=""#"" class=""service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0"">
                <img class=""card-img"" scr=""~/assets/img/services-05.jpg"" alt=""Card image"">
                <div class=""service-work-vertical card-img-overlay d-flex align-items-end"">
                    <div class=""service-work-content text-left text-light"">
        ...
        <div class=""col-xl-3 col-md-4 col-sm-6 project branding"">
            <a href=""#"" class=""service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0"">
                <img class=""card-img"" scr=""~/assets/img/services-06.jpg"" alt=""Card image"">
                <div class=""service-work-vertical card-img-overlay d-flex align-items-end"">
                    <div class=""service-work-content text-left text-light"">
        ...
        <div class=""col-xl-3 col-md-4 col-sm-6 project branding"">
            <a href=""#"" class=""service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0"">
                <img class=""card-i");
            WriteLiteral(@"mg"" scr=""~/assets/img/services-07.jpg"" alt=""Card image"">
                <div class=""service-work-vertical card-img-overlay d-flex align-items-end"">
                    <div class=""service-work-content text-left text-light"">
        ...
        <div class=""col-xl-3 col-md-4 col-sm-6 project ui graphic branding"">
            <a href=""#"" class=""service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0"">
                <img class=""card-img"" scr=""~/assets/img/services-08.jpg"" alt=""Card image"">
                <div class=""service-work-vertical card-img-overlay d-flex align-items-end"">
                    <div class=""service-work-content text-l");
            WriteLiteral(@"eft text-light"">
    ...
    <div class=""container py-5"">
        <div class=""row d-flex justify-content-center text-center"">
            ...
            <div class=""col-lg-3 col-12 pt-4"">
                <a href=""#");
            WriteLiteral(@""" class=""btn btn-primary rounded-pill btn-block shadow px-4 py-2"">View Our Work</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class=""row gy-5 g-lg-5 mb-4"">
            ...
            <div class=""col-md-4 mb-3"">
                <a href=""#"" class=""recent-work card border-0 shadow-lg overflow-hidden"">
                    <img class=""recent-work-img card-img"" scr=""~/assets/img/recent-work-01.jpg"" alt=""Card image"">
                    <div class=""recent-work-vertical card-img-overlay d-flex align-items-end"">
                        <div class=""recent-work-content text-start mb-3 ml-3 text-dark"">
                            <h3 class=""card-title light-300"">Social Media</h3>
           ");
            WriteLiteral(@"                 <p class=""card-text"">Ullamco laboris nisi ut aliquip ex</p>
                        </div>
                    </div>
                </a>
            </div><!-- End Recent Work -->
            ...
            <div class=""col-md-4 mb-3"">
                <a href=""#"" class=""recent-work card border-0 shadow-lg overflow-hidden"">
                    <img class=""recent-work-img card-img"" scr=""~/assets/img/recent-work-02.jpg"" alt=""Card image"">
                    <div class=""recent-work-vertical card-img-overlay d-flex align-items-end"">
                        <div class=""recent-work-content text-start mb-3 ml-3 text-dark"">
            ...
            WriteLiteral(@"div class=""col-md-4 mb-3"">
                <a href=""#"" class=""recent-work card border-0 shadow-lg overflow-hidden"">
                    <img class=""recent-work-img card-img"" scr=""~/assets/img/recent-work-03.jpg"" alt=""Card image"">
                    <div class=""recent-work-vertical card-img-overlay d-flex align-items-end"">
                        <div class=""recent-work-content text-start mb-3 ml-3 text-dark"">
            ...
            <div class=""col-md-4 mb-3"">
                <a href=""#"" class=""recent-work card border-0 shadow-lg overflow-hidden"">
                    <img class=""recent-work-img card-img"" scr=""~/assets/img/recent-work-04.jpg"" alt=""Card image"">
                    <div class=""recent-w");
            WriteLiteral(@"ork-vertical card-img-overlay d-flex align-items-end"">
                        <div class=""recent-work-content text-start mb-3 ml-3 text-dark"">
            ...
            <div class=""col-md-4 mb-3"">
                <a href=""#"" class=""recent-work card border-0 shadow-lg overflow-hidden"">
                    <img class=""recent-work-img card-img"" scr=""~/assets/img/recent-work-05.jpg"" alt=""Card image"">
                    <div class=""recent-work-vertical card-img-overlay d-flex align-items-end"">
                        <div class=""recent-work-content text-start mb-3 ml-3 text-dark"">
                            <h3 class=""card-title light-300"">Branding</h3>
                            <p class=""ca");
            WriteLiteral(@"rd-text"">Put enim ad minim veniam</p>
                        </div>
                    </div>
                </a>
            </div><!-- End Recent Work -->
            ...
            <div class=""col-md-4 mb-3"">
                <a href=""#"" class=""recent-work card border-0 shadow-lg overflow-hidden"">
                    <img class=""recent-work-img card-img"" scr=""~/assets/img/recent-work-06.jpg"" alt=""Card image"">
                    <div class=""recent-work-vertical card-img-overlay d-flex align-items-end"">
                        <div class=""recent-work-content text-start mb-3 ml-3 text-dark"">
